...
DROP TABLE IF EXISTS `core_people`;
...
INSERT INTO `core_courier_branchs` (`id`,`name`) VALUES
(1,'Dhaka Central Branch'),
(2,'Chittagong Main Hub'),
(3,'Khulna Regional Office'),
(4,'Rajshahi Courier Point'),
(5,'Sylhet Dispatch Center'),
(6,'Barisal Delivery Station'),
(7,'Rangpur North Branch'),
(8,'Cumilla City Branch'),
(9,'Narayanganj Express Outlet');
...
INSERT INTO `core_courier_parcel_history` 
(`id`,`parcel_id`, `status_id`, `person_id`, `branch_id`, `created_at`, `remark`) 
VALUES
(1,1, 1, 1, 1, '2025-06-20 09:30:00', 'Parcel received at Dhaka Central Branch'),
(2,2, 2, 2, 1, '2025-06-20 11:15:00', 'Parcel handed over to courier'),
(3,3, 2, 3, 2, '2025-06-21 14:40:00', 'Parcel arrived at Chittagong Main Hub'),
(4,4, 3, 3, 3, '2025-06-18 10:00:00', 'Parcel received at Rajshahi Courier Point'),
(5,2, 4, 4, 4, '2025-06-18 12:20:00', 'Out for delivery');
...
INSERT INTO `core_courier_parcel_statuses` (`id`,`name`) VALUES
(1,'Created'),
(2,'Dispatched'),
(3,'Arrived at Branch'),
(4,'Out for Delivery'),
...
INSERT INTO `core_courier_parcels` 
(`id`,`type_id`, `sender_id`, `receiver_id`, `weight`, `created_at`, `update_at`, `is_csc`, `branch_id`, `vehical_id`, `shipment_id`, `person_id`, `price`, `remark`, `paid_amount`, `vat`) 
VALUES
(1,2, 1, 2, 500, '2025-06-20 10:00:00', '2025-06-20 10:00:00', 0, 3, 1, 2, 1, 300.00, 'Parcel created', 300.00, 00),
(2,1, 3, 1, 250, '2025-06-20 11:30:00', '2025-06-20 11:30:00', 1, 1, 2, 1, 2, 150.00, NULL, 150.00, 00),
(3,3, 2, 3, 300, '2025-06-21 09:45:00', '2025-06-21 09:45:00', 0, 2, 3, 3, 3, 450.00, 'Urgent delivery', 450.00, 00);
...
INSERT INTO `core_courier_receivers` (`id`,`name`, `contact`, `address`) VALUES
(1,'Rahim Uddin', '01710000001', 'House 10, Road 12, Dhanmondi, Dhaka'),
(2,'Nasima Akter', '01820000002', '42 Shahid Sarani, Agrabad, Chittagong'),
(3,'Kazi Anwar', '01930000003', 'Sector 5, Uttara, Dhaka'),
(4,'Fahmida Yasmin', '01640000004', 'Sonadanga, Khulna'),
(5,'Rehana Begum', '01510000010', 'Comilla Cantonment, Cumilla');
...
INSERT INTO `core_courier_senders` (`id`,`name`, `contact`, `address`) VALUES
(1,'Md. Ashraful Alam', '01711000011', 'Mohakhali, Dhaka'),
(2,'Shahida Parvin', '01822000012', 'Panchlaish, Chittagong'),
(3,'Jamal Uddin', '01933000013', 'KDA Avenue, Khulna'),
(4,'Lamia Hossain', '01644000014', 'New Market, Rajshahi'),
(5,'Farzana Sultana', '01766000016', 'Nathullabad, Barisal');
...
INSERT INTO `core_courier_types` (`id`,`name`) VALUES
(1,'Document'),
(2,'Others'),
(3,'Parcel'),
(4,'Liquid Item'),
...
INSERT INTO `core_courier_vehicle_types` (`id`,`name`) VALUES
(1,'Motorcycle'),
(2,'Pickup Van'),
(3,'Truck'),
(4,'Bicycle'),
...
INSERT INTO `core_courier_vehicles` (`id`,`name`, `type_id`, `driver_id`) VALUES
(1,'Dhaka-CTG-001', 1, 1),
(2,'Bike-017-DHK', 3, 2),
(3,'Pickup-KHL-22', 2, 1),
(4,'Mini Truck-CTG-3', 4, 3),
(5,'Covered-DHK-88', 5, 4);
...
INSERT INTO `core_users0` (`id`,`name`,`email`,`email_verified_at`,`password`,`remember_token`,`created_at`,`updated_at`) VALUES 
 (1,'admin','jahid1@yahoo.com',NULL,'111111',NULL,'2024-06-12 04:46:24','2024-06-12 04:46:24'),
 (2,'Farjana Khan', 'farjana@example.com', NULL, '222222', NULL,'2024-07-13 04:48:24','2024-07-14 04:50:24'),
(3,'Rahim Uddin', 'rahim@example.com', NULL, '333333', NULL,'2024-08-12 04:46:24','2024-08-12 04:46:24'),
(4,'Karim Ahmed', 'karim@example.com', NULL, '444444', NULL,'2024-09-12 04:46:24','2024-09-12 04:46:24'),
(5,'Nusrat Jahan', 'nusrat@example.com',NULL, '555555', NULL,'2024-10-12 04:46:24','2024-10-12 04:46:24');
...
INSERT INTO `core_warehouses` (`id`,`name`,`city`,`contact`) VALUES 
 ...
 DROP TABLE IF EXISTS `core_courier_invoices`;
CREATE TABLE  `core_courier_invoices` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `sender_id` int(10) unsigned NOT NULL,
  `created_at` datetime NOT NULL,
  `remark` varchar(45) NOT NULL,
...
INSERT INTO `core_courier_invoices` 
(`sender_id`, `created_at`, `remark`, `payment_term`, `updated_at`, `invoice_total`, `paid_total`)
VALUES
(1, '2025-06-01 10:15:00', 'Monthly invoice', 'NET 30', '2025-06-01 10:15:00', 1500.00, 1500.00),
(2, '2025-06-05 09:30:00', 'Late payment penalty', 'Due on Receipt', '2025-06-06 12:00:00', 300.00, 0.00),
(3, '2025-06-10 14:45:00', 'Regular shipment', 'NET 15', '2025-06-11 08:20:00', 2200.00, 1100.00),
(1, '2025-06-15 16:00:00', 'June invoice', 'NET 30', '2025-06-16 09:10:00', 1800.00, 1800.00),
(4, '2025-06-20 11:25:00', 'Courier charges', 'NET 45', '2025-06-21 13:30:00', 500.00, 250.00);
...
DROP TABLE IF EXISTS `core_courier_invoice_details`;
CREATE TABLE  `core_courier_invoice_details` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `invoice_id` int(10) unsigned NOT NULL,
  `parcel_id` int(10) unsigned NOT NULL,
  `price` float NOT NULL,
...
INSERT INTO `core_courier_invoice_details` 
(`invoice_id`, `parcel_id`, `price`, `qty`)
VALUES
(1, 1, 100.00, 5),
(1, 2, 200.00, 3),
(2, 3, 150.00, 2),
